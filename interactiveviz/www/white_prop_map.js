function generate_white_prop_map() {
    ...
    function popStyle (feature) {
        return {
            fillColor: getColorPop(feature.properties.PROP_WHITE),
            fillOpacity: 0.8,
            weight: 3,
            opacity: 1,
            color: "#FFFAE3",
    ...
    infoDC.update = function (props, prop_name) {
        this._div.innerHTML = '<h4>White Population</h4>' + (props ?
                    props.PROP_WHITE * 100 + "% of pop." : "Hover on Tract");
    };
